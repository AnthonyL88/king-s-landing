...
public class CommunChest : MonoBehaviour
{
    ...
    private int _spawnonetime = 1; // prevent from spawning infinit loot
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("CommunChest")) // can chest be opened?
        {
            ...
            Transform chestRef = parent.Find("CommunChest");
            Animator chestAnimator = chestRef.GetComponent<Animator>();
            _chestAnimatorRef = chestAnimator;

            _weaponCreateRef = parent.Find("weaponCreatepoint");
            _potionCreateRef = parent.Find("potionCreatepoint");


            Transform OpenText = parent.Find("open e communchest tag");
            Transform CloseText = parent.Find("close e communchest tag");
